...
<table width="800" height="200" border="1" align="center">
  ...
  <tr>
    <td width="180" valign="top">
      <table width="180" border="0">
      	<%
			'mengecek role dari user yang login
  ...
  <td width="714" align="left" valign="top"><form id="form1" name="form1" method="post" action="doEditApp.asp">
    <table width="345" height="152" border="1" cellspacing="10" cellpadding="10">
      ...
      <tr>
        <td colspan="2" align="center">Edit Appointment</td>
      </tr>
      <tr>
