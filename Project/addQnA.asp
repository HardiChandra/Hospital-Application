  ...
  <tr>
    <td width="180" valign="top">
      <table width="180" border="0">
      	<%
			'memvalidasi user berdasarkan role
    ...
    <form action="doAddQnA.asp">
  	<table border="1" cellpadding="10" cellspacing="10">
    	<tr>
        	<td colspan="2" align="center">Add QnA</td>
        </tr>
    	<tr>
        	<td valign="top">Add QnA : </td>
            <td><textarea name="QnA" rows="4"></textarea></td>
        </tr>
        <tr>
