...
<table width="800" height="200" border="1" align="center">
  ...
  <td width="714" align="left" valign="top">
  	...
  	<table border="1">
    	<tr>
            ...
            <tr>
                ...
                <td><%=rs(7)%></td>
                <td><%=rs(6)%></td>
                <td><a href="doDeletePasien.asp?id=<%=rs(0)%>">Delete</a></td>
               </tr>
            <%
            		rs.movenext
                 wend
    ...
    <table border="1">
        ...
        <%
				'menampilkan seluruh data dokter
            ...
            <tr>
                ...
                <td><%=rs(3)%></td>
                <td><%=rs(5)%></td>
                <td><a href="doDeleteDokter.asp?id=<%=rs(0)%>">Delete</a></td>
               </tr>
            <%
            		rs.movenext
                 wend
